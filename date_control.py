...
class date_control():
    ...
    def do_sql(self, xsd, roles_def, rinok, ep,iskl):
        ...
        columns_final_df=['to_sort', 'parentrole', 'concept', 'dimension', 'period_start', 'period_end', 'new_dimension',
        ...
        columns_final_df_dd=['concept', 'dimension', 'period_start', 'period_end', 'new_dimension', 'uri_razdel','parentrole_text', 'entity']
        check2 = False
        line_final_df_dd=[]
        ...
        for j, yy in final_df_dd.iterrows():
            ...
            line_temp.append([ep, yy['concept'], ';'.join(dim) if dim else None, None, yy['period_start'], yy['period_end'],
