...
group by version,rinok,entity,parentrole 	
    ...
    def compare_dataframes(self, dataframe1, dataframe2,roles_bfo_dict):
        ...
        for row1 in self.generator_dd_df(dataframe1):
            ...
            dimension1_clear = list(set([xx.split('#')[0] for xx in row1['dimension']]))
            dimension1_clear = set(dimension1_clear) if dimension1_clear else {}
            ...
            for row2 in self.generator_dd_df(ser):
                ...
                dimension2_clear = list(set([xx.split('#')[0] for xx in row2['dimension']]))
                dimension2_clear = set(dimension2_clear) if dimension2_clear else {}
